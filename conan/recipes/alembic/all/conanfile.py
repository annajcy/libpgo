...
class AlembicConan(ConanFile):
    ...
    default_options = {
        "shared": False,
        "fPIC": True,
        "with_hdf5": True, # HDF5 IS ENABLED BY DEFAULT HERE
    }
    ...
    def source(self):
        get(self, url="https://github.com/alembic/alembic/archive/refs/tags/1.8.9.tar.gz",
    ...
    def generate(self):
        ...
        tc.variables["ALEMBIC_ILMBASE_LINK_STATIC"] = True
