...
| cubic boundary surface | `examples/experiments/tricubic_hermite_fem/assets/obj/bunny-conservative-r15-surface.obj` |
| refined cubic-linear mesh | `examples/experiments/tricubic_hermite_fem/assets/veg/cubic/bunny-conservative-r15-subdiv2.veg` |
| tet baseline mesh | `examples/experiments/tricubic_hermite_fem/assets/veg/tet/bunny-conservative-r15-tet-a2.8768e-9.veg` |
...
conda run -n libpgo python examples/experiments/tricubic_hermite_fem/mesh/subdivide_cubic_mesh.py \
  ...
  --output examples/experiments/tricubic_hermite_fem/assets/veg/cubic/bunny-conservative-r15-subdiv2.veg
```
