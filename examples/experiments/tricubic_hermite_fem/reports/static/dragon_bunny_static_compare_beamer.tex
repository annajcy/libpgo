...
\begin{frame}{DOF Scale}
  ...
  \begin{table}
    ...
    \begin{tabular}{lrrrr}
      ...
      \midrule
      dragon & 631,650 & 15,768 & 105,027 & 126,144 \\
      bunny & 365,184 & 9,102 & 62,355 & 72,816 \\
      \bottomrule
    \end{tabular}
  \end{table}
...
\begin{frame}{Scale and Constraint Metrics}
  ...
  \vspace{0.6em}
  Wall time is reported as an implementation cost metric.
\end{frame}
...
\begin{frame}{Dragon: Accuracy}
  ...
  \begin{table}
    ...
    \begin{tabular}{lrrrr}
      ...
      \midrule
      \case{cubic_linear} & 15,768 & \pct{13.67} & \pct{13.19} & 0.02632 \\
      \case{cubic_linear_x8} & 105,027 & \pct{2.68} & \pct{2.63} & 0.00522 \\
      \case{cubic_hermite} & 126,144 & \good{\pct{0.77}} & \good{\pct{0.40}} & \good{0.00157} \\
      \bottomrule
    \end{tabular}
  \end{table}
  ...
  \begin{itemize}
    ...
    \item Hermite still lowers free-surface relative L2 by about 3.5x versus x8 cubic-linear.
  \end{itemize}
\end{frame}
...
\begin{frame}{Dragon: Cost}
  ...
  \begin{table}
    ...
    \begin{tabular}{lrrr}
      \toprule
      case & iterations & wall time & pin residual \\
      \midrule
      \case{tet_ref} & 31 & 451.8 s & 0.000581 \\
      \case{cubic_linear} & 32 & 12.1 s & 0.000925 \\
      \case{cubic_linear_x8} & 32 & 45.0 s & 0.001002 \\
      \case{cubic_hermite} & 32 & \cost{242.7 s} & 0.000548 \\
      \bottomrule
    \end{tabular}
  \end{table}
  ...
  \vspace{0.8em}
  \begin{itemize}
    \item Hermite is more accurate but 5.4x slower than x8 cubic-linear.
...
\begin{frame}{Bunny: Accuracy}
  ...
  \begin{table}
    ...
    \begin{tabular}{lrrrr}
      ...
      case & DOFs & free rel L2 & y rel L2 & p95 error \\
      \midrule
      \case{cubic_linear} & 9,102 & \pct{19.72} & \pct{19.84} & 0.00547 \\
      \case{cubic_linear_x8} & 62,355 & \pct{7.19} & \pct{6.27} & 0.00209 \\
      \case{cubic_hermite} & 72,816 & \good{\pct{0.83}} & \good{\pct{0.72}} & \good{0.00024} \\
      \bottomrule
    \end{tabular}
  \end{table}
  ...
  \begin{itemize}
    ...
    \item Hermite lowers free-surface relative L2 by about 8.7x versus x8 cubic-linear.
  \end{itemize}
\end{frame}
...
\begin{frame}{Bunny: Cost}
  ...
  \begin{table}
    ...
    \begin{tabular}{lrrr}
      ...
      case & iterations & wall time & pin residual \\
      \midrule
      \case{tet_ref} & 26 & 369.5 s & 0.000030 \\
      \case{cubic_linear} & 26 & 5.2 s & 0.000068 \\
      \case{cubic_linear_x8} & 24 & 37.0 s & 0.000048 \\
      \case{cubic_hermite} & 30 & \cost{179.1 s} & 0.000034 \\
      \bottomrule
    \end{tabular}
  \end{table}
  ...
  \vspace{0.8em}
  \begin{itemize}
    \item Hermite is 4.8x slower than x8 cubic-linear in the local run.
...
\begin{frame}{Displacement Scale}
  ...
  \begin{table}
    ...
    \begin{tabular}{lrrrr}
      ...
      \midrule
      dragon & 0.138239 & -13.23\% & -2.40\% & \good{-0.12\%} \\
      bunny & 0.021180 & -14.54\% & -4.39\% & \good{-0.13\%} \\
      \bottomrule
    \end{tabular}
  \end{table}
  ...
  \begin{itemize}
    ...
    \item Hermite is within about 0.13\% of the x5 tet reference in displacement scale.
  \end{itemize}
\end{frame}
...
\begin{frame}{Cross-Case Summary}
  ...
  \begin{table}
    ...
    \begin{tabular}{lccc}
      ...
      \midrule
      dragon free rel L2 & \pct{13.67} & \pct{2.68} & \good{\pct{0.77}} \\
      bunny free rel L2 & \pct{19.72} & \pct{7.19} & \good{\pct{0.83}} \\
      \bottomrule
    \end{tabular}
  \end{table}
  ...
  \begin{table}
    ...
    \begin{tabular}{lcc}
      ...
      \midrule
      dragon & 3.5x lower error & 5.4x slower \\
      bunny & 8.7x lower error & 4.8x slower \\
      \bottomrule
    \end{tabular}
  \end{table}
\end{frame}
...
\begin{frame}{Interpretation}
  ...
  \begin{itemize}
    ...
    \item The practical tradeoff is clear: Hermite buys accuracy with substantially higher factorization time.
  \end{itemize}
\end{frame}
...
\begin{frame}{Conclusion}
  ...
  \vspace{0.7em}
  \begin{itemize}
    \item Dragon: free rel L2 drops from \pct{13.67} to \pct{2.68} to \good{\pct{0.77}}.
    \item Bunny: free rel L2 drops from \pct{19.72} to \pct{7.19} to \good{\pct{0.83}}.
...
\begin{frame}{Reproducibility Pointers}
  ...
  \begin{itemize}
    ...
    \item Static compare runner: \texttt{examples/experiments/tricubic\_hermite\_fem/run\_static.py}
    \item Cubic asset generator: \texttt{examples/experiments/tricubic\_hermite\_fem/mesh/generate\_cubic\_mesh.py}
    \item Cubic subdivision script: \texttt{examples/experiments/tricubic\_hermite\_fem/mesh/subdivide\_cubic\_mesh.py}
    \item Tet reference tuning script: \texttt{examples/experiments/tricubic\_hermite\_fem/mesh/tune\_tet\_reference.py}
  \end{itemize}
\end{frame}
