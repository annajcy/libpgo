...
```text
examples/experiments/tricubic_hermite_fem/output/<study>/<mode>/<case>
```
...
The hand-written static reports interpret the fresh five-case server matrices
from 2026-07-22. Dynamic reports still document pre-matrix runs and remain
historical until the corresponding fresh dynamic matrices complete. The
reports are not generated automatically; the machine-readable comparison files
under `examples/experiments/tricubic_hermite_fem/output/<study>/<mode>/` remain the numeric
source of truth.
