#!/usr/bin/env python3
"""Generate a connected cubic mesh for a static compare asset."""
...
CASES = {
    "dragon": ASSETS / "obj" / "dragon.obj",
    "bunny": ASSETS / "obj" / "bunny.obj",
}
...
def main(argv=None) -> int:
    ...
    surface_path = args.surface or CASES[args.case]
    stem = f"{args.case}-{args.occupancy}-r{args.resolution}"
