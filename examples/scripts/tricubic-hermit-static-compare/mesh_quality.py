...
CASES = {
    "dragon": {
        ...
        "tet": ASSETS / "veg" / "tet" / "dragon-conservative-r15-tet-a1.47683e-7.veg",
        "cubic": ASSETS / "veg" / "cubic" / "dragon-conservative-r15.veg",
    },
    "bunny": {
        "surface": ASSETS / "obj" / "bunny.obj",
        "tet": ASSETS / "veg" / "tet" / "bunny-conservative-r15-tet-a2.89036e-9.veg",
