...
- `dragon_formulation_comparison.py` — static formulation study (tet
  ...
  The interactive notebook version is
  `examples/dragon_formulation_comparison_demo.ipynb` (generated by
  `generate_dragon_formulation_comparison_demo.py`), with pinned-patch and
  deformed-surface visualizations.
