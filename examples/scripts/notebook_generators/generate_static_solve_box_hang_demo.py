...
Run from the repository root:
    ...
    conda run -n libpgo python examples/scripts/notebook_generators/generate_static_solve_box_hang_demo.py
"""
...
CELLS = [
    ...
    code(
        ...
        plastic_values = deformation.plastic_field.values
        ...
        print("field values match input:", np.allclose(deformation_plastic.plastic_field.values, plastic_values))
