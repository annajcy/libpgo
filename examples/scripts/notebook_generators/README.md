...
These scripts generate notebooks under `examples/`:
...
Edit the generator script, then regenerate from the repository root:

```bash
conda run -n libpgo python examples/scripts/notebook_generators/generate_contact_api_demo.py
conda run -n libpgo python examples/scripts/notebook_generators/generate_mesh_api_demo.py
conda run -n libpgo python examples/scripts/notebook_generators/generate_numpy_interoperate.py
conda run -n libpgo python examples/scripts/notebook_generators/generate_static_solve_dragon_gravity_demo.py
conda run -n libpgo python examples/scripts/notebook_generators/generate_tricubic_hermite_box_drop_ipc_demo.py
```
