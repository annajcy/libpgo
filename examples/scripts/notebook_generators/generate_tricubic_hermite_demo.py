...
Run from the repository root:
    ...
    conda run -n libpgo python examples/scripts/notebook_generators/generate_tricubic_hermite_demo.py
"""
    ...
    code(
        ...
        def solve_static(energy, stride, label):
            ...
            optimizer = ps.NewtonOptimizer(
                max_iterations=200, gradient_tolerance=1e-4, damping=ps.FixedDamping(), line_search=ps.Backtrack())
