...
Run from the repository root:
    ...
    conda run -n libpgo python examples/scripts/notebook_generators/generate_solver_api_demo.py
"""
...
CELLS = [
    ...
    code(
        ...
        for line_search in line_searches:
            mode_optimizer = solver.NewtonOptimizer(line_search=line_search, damping=solver.NoDamping())
