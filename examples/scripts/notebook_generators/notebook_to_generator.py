...
Usage:
    ...
    conda run -n libpgo python examples/scripts/notebook_generators/notebook_to_generator.py examples/mesh_api_demo.ipynb
...
Run from the repository root:
    ...
    conda run -n libpgo python examples/scripts/notebook_generators/{script_name}.py
"""
...
def notebook_to_generator(notebook_path: Path, output_path: Path | None = None) -> Path:
    ...
    output_path : Path or None
        ...
        ``examples/scripts/notebook_generators/generate_<stem>.py`` alongside the other generators.
    ...
    if output_path is None:
        root = repo_root()
        output_path = root / "examples" / "scripts" / "notebook_generators" / f"generate_{stem}.py"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output path for the generator script (default: examples/scripts/notebook_generators/generate_<stem>.py).",
    )
