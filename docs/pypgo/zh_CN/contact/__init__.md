...
| `SampledPenaltyEnergy` | `energies.py` | `StatefulContactMixin + PotentialEnergy` | [energies.md](energies.md) |
| `FrictionalSampledPenaltyEnergy` | `energies.py` | 同上（摩擦版） | [energies.md](energies.md) |
