...
DYNAMIC_CASES = [
    ...
    (cubic_dynamic, "cubic_dynamic_box_sphere_ipc_trbdf2.json"),
    (tet_dynamic, "tet_dynamic_box_sphere_sampled_penalty.json"),
    (cubic_dynamic, "cubic_dynamic_box_sphere_sampled_penalty.json"),
