...
NonlinearOptimization::StepConstraint ImplicitBackwardEulerEnergy::computeMaxStepLimit(ES::ConstRefVecXd x, ES::ConstRefVecXd dx, StepConstraintSink *sink) const
{
