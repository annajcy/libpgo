...
MaterialParameterSpec StVKConfig::parameterSpec() const { return numberedChannels(0); }
void StVKConfig::initializeDefaultParameters(const SimulationMesh &, int, std::span<double> output) const { expectSize(output, 0); }
