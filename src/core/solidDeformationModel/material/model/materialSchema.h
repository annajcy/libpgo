...
{
public:
  ParameterInputSchema() = default;
  ParameterInputSchema(std::initializer_list<std::string_view> names);
  explicit ParameterInputSchema(std::span<const std::string_view> names);
  explicit ParameterInputSchema(std::vector<std::string> names);
