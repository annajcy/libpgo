...
ParameterInputSchema::ParameterInputSchema(
  std::initializer_list<std::string_view> names):
  ParameterInputSchema(std::span<const std::string_view>(
...
ParameterInputSchema::ParameterInputSchema(
  ...
  ParameterInputSchema(ownNames(names))
{
}
...
{
  validateNames(parameterNames_, "ParameterInputSchema");
}

bool ParameterInputSchema::contains(std::string_view parameterName) const
{
  return std::find(
...
int ParameterInputSchema::parameterIndex(std::string_view parameterName) const
{
  return findName(parameterNames_, parameterName, "ParameterInputSchema");
}
