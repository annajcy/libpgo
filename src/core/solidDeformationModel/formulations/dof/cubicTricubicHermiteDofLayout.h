...
// "node = corner*8 + mode" ordering the mapping consumes:
...
class CubicTricubicHermiteDofLayout : public DofLayout
{
public:
  ...
  explicit CubicTricubicHermiteDofLayout(const SimulationMesh &mesh);
