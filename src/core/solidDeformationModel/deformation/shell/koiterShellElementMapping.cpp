...
KoiterShellElementMapping::KoiterShellElementMapping(const double restX[18], const bool hasVtx[6])
{
  for (int i = 0; i < 6; i++) {
...
ES::M2d KoiterShellElementMapping::compute_a_and_derivatives(
  const ES::V3d x[3],
...
ES::M2d KoiterShellElementMapping::compute_b_and_derivatives(
  const ES::V3d x[6],
...
ES::V3d KoiterShellElementMapping::secondFundamentalFormEntries(
  const ES::V3d x[6],
...
ES::V3d KoiterShellElementMapping::faceNormal(
