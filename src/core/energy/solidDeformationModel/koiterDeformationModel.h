...
public:
    KoiterDeformationModel(const double X0[3], const double X1[3], const double X2[3], const double X3[3],
                           const double X4[3], const double X5[3], ElasticModel* elasticModel,
                           PlasticModel* plasticModel, int enforceSPD);
