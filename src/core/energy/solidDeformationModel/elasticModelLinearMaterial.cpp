...
double ElasticModelLinearMaterial::compute_psi(const double*, const double F[9], const double[9], const double[9],
...
void ElasticModelLinearMaterial::compute_P(const double*, const double F[9], const double[9], const double[9],
...
void ElasticModelLinearMaterial::compute_dPdF(const double*, const double F[9], const double[9], const double[9],
