...
public:
    PlasticModel3DDeformationGradient(int np) : numParams(np) {}
    ...
    virtual void compute_dparamfull_dparamsub(const double* param, const double* basis, int numHandles,
                                              double* dpf_dps) const;
    virtual bool has2OrderDeriv() const { return false; }
    virtual void compute_d2paramfull_dparamsub2(const double* param, const double* basis, int numHandles, int pi,
                                                double* d2a_dz2) const;
...
inline void PlasticModel3DDeformationGradient::compute_dparamfull_dparamsub(const double*, const double*, int,
                                                                            double*) const {}

inline void PlasticModel3DDeformationGradient::compute_d2paramfull_dparamsub2(const double*, const double*, int, int,
                                                                              double*) const {}
