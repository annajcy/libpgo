...
public:
    ...
    // inline static double d3E_dx3_ijk(const double *tensor, int i, int j, int k) { return
    // DeformationModel::d3E_dx3_ijk(tensor, i, j, k, 12); } inline static double &d3E_dx3_ijk(double *tensor, int i,
    // int j, int k) { return DeformationModel::d3E_dx3_ijk(tensor, i, j, k, 12); }
