...
DeformationModelAssembler::DeformationModelAssembler(std::shared_ptr<const DeformationModelManager> dm,
...
double DeformationModelAssembler::computeEnergy(const double* x, const double* plasticParams,
...
void DeformationModelAssembler::computeGradient(const double* x, const double* plasticParams,
                                                const double* elasticParams, double* grad) const {
...
void DeformationModelAssembler::computeHessian(const double* x, const double* plasticParams,
                                               const double* elasticParams, EigenSupport::SpMatD& hess) const {
...
void DeformationModelAssembler::compute_df_da(const double* x, const double* plasticParams, const double* elasticParams,
...
void DeformationModelAssembler::compute_df_db(const double* x, const double* plasticParams, const double* elasticParams,
                                              EigenSupport::SpMatD& hess) const {
    memset(hess.valuePtr(), 0, sizeof(double) * hess.nonZeros());
...
void DeformationModelAssembler::computeVonMisesStresses(const double* x, const double* plasticParams,
                                                        const double* elasticParams, double* elementStresses) const {}

void DeformationModelAssembler::computeMaxStrains(const double* x, const double* plasticParams,
                                                  const double* elasticParams, double* elementStrain) const {}
