...
ElasticModelHillTypeMaterial::ElasticModelHillTypeMaterial(double shapeParam, double maximalContractionForce,
    ...
    : gamma(shapeParam), maxf(maximalContractionForce), lo(optimalLengthRatio) {
...
double ElasticModelHillTypeMaterial::compute_psi(const double* param, const double F[9], const double* /*U[9]*/,
...
void ElasticModelHillTypeMaterial::compute_P(const double* param, const double F[9], const double* /*U[9]*/,
...
void ElasticModelHillTypeMaterial::compute_dPdF(const double* param, const double F[9], const double* /*U[9]*/,
...
void ElasticModelHillTypeMaterial::compute_d2ldF2(const double* /*F[9]*/, const double FdIn[],
                                                  double d2ldF2Out[81]) const {
    ES::V3d d    = Eigen::Map<const ES::V3d>(fiberDirection);
    ES::V3d Fd   = Eigen::Map<const ES::V3d>(FdIn);
    ES::M3d FddT = ES::tensorProduct(Fd, d);
...
double ElasticModelHillTypeMaterial::compute_dpsi_dparam(const double* /*param*/, int /*i*/, const double F[9],
...
void ElasticModelHillTypeMaterial::compute_dP_dparam(const double* /*param*/, int /*i*/, const double F[9],
                                                     const double* /*U[9]*/, const double* /*V[9]*/,
