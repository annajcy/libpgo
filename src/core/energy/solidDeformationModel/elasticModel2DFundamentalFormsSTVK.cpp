...
static inline ES::V4d vecCM(const ES::M2d& X) {  // column-major vec
    ES::V4d v;
    v << X(0, 0), X(1, 0), X(0, 1), X(1, 1);
    return v;
}

double ElasticModel2DFundamentalFormsSTVK::compute_psi_a(const double* param, const double a_[4],
                                                         const double abar_[4]) const {
    double Es   = param[0];
    double nu_s = param[1];
    double h    = param[4];
...
void ElasticModel2DFundamentalFormsSTVK::compute_dpsi_da(const double* param, const double a_[4], const double abar_[4],
                                                         double da_[4]) const {
    double Es   = param[0];
    double nu_s = param[1];
    double h    = param[4];
...
void ElasticModel2DFundamentalFormsSTVK::compute_d2psi_da2(const double* param, const double a_[4],
                                                           const double abar_[4], double da2_[16]) const {
    double Es   = param[0];
    double nu_s = param[1];
    double h    = param[4];
    ...
    ES::M4d d2EdM2;
    d2EdM2 << (lameAlpha + 2 * lameBeta), 0, 0, lameAlpha, 0, 0, 2 * lameBeta, 0, 0, 2 * lameBeta, 0, 0, lameAlpha, 0,
        0, lameAlpha + 2 * lameBeta;
...
double ElasticModel2DFundamentalFormsSTVK::compute_psi_b(const double* param, const double b_[4], const double abar_[4],
                                                         const double bbar_[4]) const {
    double Es   = param[2];
    double nu_s = param[3];
    double h    = param[4];
...
void ElasticModel2DFundamentalFormsSTVK::compute_dpsi_db(const double* param, const double b_[4], const double abar_[4],
                                                         const double bbar_[4], double db_[4]) const {
    double Es   = param[2];
    double nu_s = param[3];
    double h    = param[4];
...
void ElasticModel2DFundamentalFormsSTVK::compute_d2psi_db2(const double* param, const double b_[4],
                                                           const double abar_[4], const double bbar_[4],
                                                           double db2_[16]) const {
    double Es   = param[2];
    double nu_s = param[3];
    double h    = param[4];
...
void ElasticModel2DFundamentalFormsSTVK::compute_d2psi_dadabar(const double* param, const double a_[4],
                                                               const double abar_[4], double dadabar_[16]) const {
    double Es   = param[0];
    double nu_s = param[1];
    double h    = param[4];
...
void ElasticModel2DFundamentalFormsSTVK::compute_d2psi_db_dabar(const double* param, const double b_[4],
                                                                const double abar_[4], const double bbar_[4],
                                                                double dbdabar_[16]) const {
    double Es   = param[2];
    double nu_s = param[3];
    double h    = param[4];
...
void ElasticModel2DFundamentalFormsSTVK::compute_d2psi_db_dbbar(const double* param, const double b_[4],
                                                                const double abar_[4], const double bbar_[4],
                                                                double dbdbbar_[16]) const {
    double Es   = param[2];
    double nu_s = param[3];
    double h    = param[4];
...
void ElasticModel2DFundamentalFormsSTVK::compute_d2psi_da_dparam(const double* param, const double a_[4],
                                                                 const double abar_[4],
                                                                 double       d2psi_dadparam[/*4 x numParams*/]) const {
    double Es   = param[0];
    double nu_s = param[1];
    double h    = param[4];
    ...
    ES::M2d dS_dnu =
        dS_dalpha * (Es * (1 + 2 * nu_s * nu_s) / ((1 + nu_s) * (1 + nu_s) * (1 - 2 * nu_s) * (1 - 2 * nu_s)));
...
void ElasticModel2DFundamentalFormsSTVK::compute_d2psi_db_dparam(const double* param, const double b_[4],
                                                                 const double abar_[4], const double bbar_[4],
                                                                 double d2psi_dbdparam[/*4 x numParams*/]) const {
    double Es   = param[2];
    double nu_s = param[3];
    double h    = param[4];
