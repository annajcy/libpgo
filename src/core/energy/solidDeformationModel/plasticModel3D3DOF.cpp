...
PlasticModel3D3DOF::PlasticModel3D3DOF(const double R_[9]) : PlasticModel3DDeformationGradient(3) {
...
void PlasticModel3D3DOF::compute_dparamfull_dparamsub(const double*, const double* basis, int numHandles,
...
void PlasticModel3D3DOF::compute_d2paramfull_dparamsub2(const double* param, const double* basis, int numHandles,
