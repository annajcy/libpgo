...
public:
    MultipleVertexPullingSoftConstraintsPOrder(const EigenSupport::SpMatD& Koff,
                                               const EigenSupport::VXd& restPositionsAll, int numPoints,
                                               const double* constraintCoeffs, const double* constraintTargetPositions,
                                               const double* constraintNormals, const int* idx, double bcCoeff,
                                               int useN, int isInputDisplacement, double pvalue);
