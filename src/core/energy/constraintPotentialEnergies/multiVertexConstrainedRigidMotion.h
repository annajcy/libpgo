...
public:
    MultipleVertexConstrainedRigidMotion(const EigenSupport::VXd& restPositions, const std::vector<int>& vertexIndices,
                                         const double* vertexWeights, double coeffR, double coefft,
                                         bool flexibleRigidMotion, bool isDisp);
