...
public:
    BarycentricCoordinateSliding(const EigenSupport::SpMatD& Koff, const EigenSupport::VXd& restPositionsAll,
                                 int numPoints, const double* constraintCoeffs, const double* constraintTargetPositions,
                                 const double* constraintNormals, const int* idx, const double* barycentricWeights,
                                 int numElementVertices, double bcCoeff, int useN, int checkPenetration,
