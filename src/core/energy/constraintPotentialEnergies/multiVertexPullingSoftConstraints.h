...
public:
    MultipleVertexPulling(const EigenSupport::SpMatD& Koff, const double* restPositionsAll, int numPts,
                          const int* vertexIndices, const double* tgt, const double* bcCoeff, int isDisp);
