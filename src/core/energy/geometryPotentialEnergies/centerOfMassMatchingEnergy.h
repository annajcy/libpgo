...
public:
    CenterOfMassMatchingEnergy(const Mesh::TetMeshGeo& tetMesh, const EigenSupport::V3d& tgtCoM,
                               const EigenSupport::M3d& projMat);
    ...
    void compute_com_and_energy_and_grad(EigenSupport::ConstRefVecXd x, EigenSupport::V3d& com, double& energy,
