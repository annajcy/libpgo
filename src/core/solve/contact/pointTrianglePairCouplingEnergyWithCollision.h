...
public:
    PointTrianglePairCouplingEnergyWithCollision(
        int numPairs, int numObjects, const std::array<int, 4>* const objectIDs,
        const std::array<int, 4>* const pointTrianglePairs, const int* const triangleIDs,
        const int* const objectDOFOffsets, const Mesh::TriMeshRef* const surfaceMeshes,
        const Mesh::TriMeshNeighbor* const surfaceMeshNeighbors, const std::vector<int>* const vertexIDToSampleIDs,
        const EigenSupport::SpMatD* const sampleEmbeddingWeights, const std::vector<double>* const sampleWeights);
...
protected:
    std::tuple<bool, int> checkContact(EigenSupport::ConstRefVecXd x, int pi, EigenSupport::V12d& xlocal,
    ...
    double frictionPotential(const EigenSupport::V12d& x, const EigenSupport::V12d& xlast, const EigenSupport::V3d& n,
                             const EigenSupport::V3d& w, double eps, double timestep) const;
    void   frictionPotentialGradient(const EigenSupport::V12d& x, const EigenSupport::V12d& xlast,
                                     const EigenSupport::V3d& n, const EigenSupport::V3d& w, double eps, double timestep,
                                     EigenSupport::V12d& grad) const;
    void   frictionPotentialHessian(const EigenSupport::V12d& x, const EigenSupport::V12d& xlast,
                                    const EigenSupport::V3d& n, const EigenSupport::V3d& w, double eps, double timestep,
                                    EigenSupport::M12d& hess) const;
    ...
    EigenSupport::EigenArray<EigenSupport::V12d>
                           gradientBlocks;  // any quadratic energy can be written as 0.5 xT * hess * x + grad(0)^T x
    ...
    PosFunction toLastPosFunc = [](const EigenSupport::V3d& x, EigenSupport::V3d& p, int) { p = x; };
