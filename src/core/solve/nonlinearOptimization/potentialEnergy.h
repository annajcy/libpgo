...
public:
    ...
    virtual void   hessianVector(EigenSupport::ConstRefVecXd x, EigenSupport::ConstRefVecXd vec,
                                 EigenSupport::RefVecXd hessVec) const;

    virtual double func_grad(EigenSupport::ConstRefVecXd x, EigenSupport::RefVecXd grad) const {
        gradient(x, grad);
        return func(x);
    }
    virtual double func_grad_hessian(EigenSupport::ConstRefVecXd x, EigenSupport::RefVecXd grad,
                                     EigenSupport::SpMatD& hess) const {
        gradient(x, grad), hessian(x, hess);
        return func(x);
    }
...
inline void PotentialEnergy::hessianVector(EigenSupport::ConstRefVecXd, EigenSupport::ConstRefVecXd,
                                           EigenSupport::RefVecXd) const {}
