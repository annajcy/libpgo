...
NonlinearProblem::NonlinearProblem(PotentialEnergy_const_p energy_) : problem(energy_) {
    problem->createHessian(energyHessian);
    xinit.resize(problem->getNumDOFs());
...
// NonlinearProblem::NonlinearProblem(PotentialEnergyDense_const_p energy_, ConstraintFunctionsDense_const_p
// constraints_):
...
ES::SpMatD& NonlinearProblem::hessian(EigenSupport::ConstRefVecXd x, EigenSupport::ConstRefVecXd lambda,
                                      double objScale) {
...
// EigenSupport::MXd &NonlinearProblem::hessianDense(EigenSupport::ConstRefVecXd x, EigenSupport::ConstRefVecXd lambda,
// double objScale)
// {
