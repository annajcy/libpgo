...
namespace NonlinearOptimization {
namespace EnergyOptimizer {
int minimizeUsingIpopt(EigenSupport::RefVecXd x, PotentialEnergy_const_p energy, EigenSupport::ConstRefVecXd xlow,
                       EigenSupport::ConstRefVecXd xhi, EigenSupport::RefVecXd lambda, EigenSupport::RefVecXd g,
                       ConstraintFunctions_const_p constraints, EigenSupport::ConstRefVecXd clow,
                       EigenSupport::ConstRefVecXd chi, int maxIter, double eps, int verbose);

int minimizeUsingNewton(EigenSupport::RefVecXd x, PotentialEnergy_const_p energy, EigenSupport::ConstRefVecXd xlow,
                        EigenSupport::ConstRefVecXd xhi, EigenSupport::RefVecXd lambda, EigenSupport::RefVecXd g,
                        ConstraintFunctions_const_p constraints, EigenSupport::ConstRefVecXd clow,
                        EigenSupport::ConstRefVecXd chi, int maxIter, double eps, int verbose);
...
int EnergyOptimizer::minimize(EigenSupport::RefVecXd x, PotentialEnergy_const_p energy,
                              EigenSupport::ConstRefVecXd xlow, EigenSupport::ConstRefVecXd xhi,
                              EigenSupport::RefVecXd lambda, EigenSupport::RefVecXd g,
                              ConstraintFunctions_const_p constraints, EigenSupport::ConstRefVecXd clow,
                              EigenSupport::ConstRefVecXd chi, SolverType solverType, int maxIter, double eps,
                              int verbose) {
    if (solverType == SolverType::ST_IPOPT) {
        ...
        return minimizeUsingKnitro(x, energy, xlow, xhi, lambda, g, constraints, clow, chi, maxIter, eps, verbose,
                                   nullptr);
    }
...
int EnergyOptimizer::minimize(EigenSupport::RefVecXd x, PotentialEnergy_const_p energy,
                              EigenSupport::ConstRefVecXd xlow, EigenSupport::ConstRefVecXd xhi, SolverType solverType,
...
int EnergyOptimizer::minimizeUsingIpopt(EigenSupport::RefVecXd x, PotentialEnergy_const_p energy,
                                        EigenSupport::ConstRefVecXd xlow, EigenSupport::ConstRefVecXd xhi,
                                        EigenSupport::RefVecXd lambda, EigenSupport::RefVecXd g,
                                        ConstraintFunctions_const_p constraints, EigenSupport::ConstRefVecXd clow,
                                        EigenSupport::ConstRefVecXd chi, int maxIter, double eps, int verbose) {
...
int EnergyOptimizer::minimizeUsingKnitro(EigenSupport::RefVecXd x, PotentialEnergy_const_p energy,
                                         EigenSupport::ConstRefVecXd xlow, EigenSupport::ConstRefVecXd xhi,
                                         EigenSupport::RefVecXd lambda, EigenSupport::RefVecXd g,
                                         ConstraintFunctions_const_p constraints, EigenSupport::ConstRefVecXd clow,
                                         EigenSupport::ConstRefVecXd chi, int maxIter, double eps, int verbose,
                                         const char* filename, int parallelEval, CallbackFunc callback,
                                         KnitroData** /*data*/, double feasTol) {
    ...
    if (constraints) {
        ...
        KnitroProblem::CallbackFunc func = [&](KnitroProblem* const ptr) {
            callback(ptr->getCurrentx().data(), (int)ptr->getCurrentx().size(), ptr->getCurrentlambda().data(),
                     (int)ptr->getCurrentlambda().size());
        };
        ...
        KnitroProblem::CallbackFunc func = [&](KnitroProblem* const ptr) {
            callback(ptr->getCurrentx().data(), (int)ptr->getCurrentx().size(), nullptr, 0);
        };
...
int EnergyOptimizer::minimizeUsingKnitroDense(EigenSupport::RefVecXd x, PotentialEnergyDense_const_p energy,
                                              EigenSupport::ConstRefVecXd xlow, EigenSupport::ConstRefVecXd xhi,
                                              EigenSupport::RefVecXd lambda, EigenSupport::RefVecXd g,
                                              ConstraintFunctionsDense_const_p constraints,
                                              EigenSupport::ConstRefVecXd clow, EigenSupport::ConstRefVecXd chi,
                                              int maxIter, double eps, int verbose, const char* filename,
                                              int parallelEval, CallbackFunc callback, KnitroData** /*data*/,
                                              double feasTol) {
#if defined(USE_KNITRO)
    if (constraints) {
        std::unique_ptr<KnitroProblem> problem = std::make_unique<KnitroProblem>(energy, constraints);
...
int EnergyOptimizer::minimizeUsingApproximateActiveSet(
    EigenSupport::RefVecXd x, PotentialEnergy_const_p energy, EigenSupport::ConstRefVecXd xlow,
    EigenSupport::ConstRefVecXd xhi, EigenSupport::RefVecXd lambda, EigenSupport::RefVecXd g,
    ConstraintFunctions_const_p constraints, EigenSupport::ConstRefVecXd clow, EigenSupport::ConstRefVecXd chi,
    ...
    if (constraints) {
        ...
        while (1) {
            ...
            std::cout << "# eq: " << std::count_if(chi1.data(), chi1.data() + chi1.size(), [](double val) {
                return val == 0;
            }) << std::endl;
...
int EnergyOptimizer::minimizeUsingNewton(EigenSupport::RefVecXd x, PotentialEnergy_const_p energy,
                                         EigenSupport::ConstRefVecXd xlow, EigenSupport::ConstRefVecXd xhi,
                                         EigenSupport::RefVecXd lambda, EigenSupport::RefVecXd g,
                                         ConstraintFunctions_const_p constraints, EigenSupport::ConstRefVecXd clow,
                                         EigenSupport::ConstRefVecXd chi, int maxIter, double eps, int verbose) {
