...
public:
    NaturalCubicSplineFitting(const EigenSupport::VXd& xVals, const EigenSupport::VXd& yVals, int numNodes,
                              double leftDeriv, double rightDeriv, double minXDist = 0.1);
