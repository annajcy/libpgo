...
ConstraintFunctionsAssembler::ConstraintFunctionsAssembler(int na) : ConstraintFunctions(na) {
...
void ConstraintFunctionsAssembler::hessianVector(ES::ConstRefVecXd x, ES::ConstRefVecXd lambda, ES::ConstRefVecXd vec,
                                                 ES::RefVecXd hessVec) const {
