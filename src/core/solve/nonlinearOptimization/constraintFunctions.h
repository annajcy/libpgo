...
public:
    ...
    virtual void hessian(EigenSupport::ConstRefVecXd x, EigenSupport::ConstRefVecXd lambda,
                         EigenSupport::SpMatD& hess) const                                = 0;
    virtual void hessianVector(EigenSupport::ConstRefVecXd x, EigenSupport::ConstRefVecXd lambda,
                               EigenSupport::ConstRefVecXd vec, EigenSupport::RefVecXd hessVec) const;
...
protected:
    void approxHessianVector(EigenSupport::ConstRefVecXd x, EigenSupport::ConstRefVecXd lambda,
                             EigenSupport::ConstRefVecXd vec, double eps, EigenSupport::SpMatD& jacBuf0,
                             EigenSupport::SpMatD& jacBuf1, EigenSupport::VXd& xleft, EigenSupport::VXd& xright,
                             EigenSupport::RefVecXd hessVec) const;
...
inline void ConstraintFunctions::hessianVector(EigenSupport::ConstRefVecXd, EigenSupport::ConstRefVecXd,
                                               EigenSupport::ConstRefVecXd, EigenSupport::RefVecXd) const {}
