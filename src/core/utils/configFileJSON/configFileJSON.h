...
public:
    ...
    std::string getString(const char* key, int forceExistance = 0) const {
        return getValue<std::string>(key, forceExistance);
    }
    std::vector<int> getVectorInt(const char* key, int forceExistance = 0) const {
        return getValue<std::vector<int>>(key, forceExistance);
    }
    std::vector<double> getVectorDouble(const char* key, int forceExistance = 0) const {
        return getValue<std::vector<double>>(key, forceExistance);
    }
    std::vector<std::string> getVectorString(const char* key, int forceExistance = 0) const {
        return getValue<std::vector<std::string>>(key, forceExistance);
    }
