...
protected:
    ...
    double g3[16][3];  // gradients for 3d noise (3 * 4 groups, however, to avoid dividing by 12, we add an extra
                       // (1,1,0), (-1,1,0), (0,-1,1) and (0,-1,-1). Please check the reference paper.)
