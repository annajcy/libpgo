...
struct FilterIterator {
    ...
    FilterIterator(Filter filter, BaseIterator base, BaseIterator end = {}) : iter_(base), end_(end), filter_(filter) {
...
template <class BaseIterator>
FilterIterator<BaseIterator> makeFilterIterator(typename FilterIterator<BaseIterator>::Filter f, BaseIterator base,
                                                BaseIterator end = {}) {
    return {f, base, end};
}
