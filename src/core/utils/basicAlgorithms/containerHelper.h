...
template <class T, class A>
std::vector<T, A> findUniqueElements(const std::vector<T, A> vec, std::vector<int>* inpID2unqID = nullptr,
                                     std::vector<int>* unqID2inpID = nullptr);
...
template <class T, class A>
std::vector<T, A> findUniqueElements(const std::vector<T, A> vec, std::vector<int>* inpID2unqID,
                                     std::vector<int>* unqID2inpID) {
    std::vector<T, A> ret;
    if (inpID2unqID)
    ...
    auto cmp = [&](const int& p0, const int& p1) { return vec[p0] < vec[p1]; };
