...
pgo::Mesh::TriMeshGeo pgo::GeogramInterface::remesh(const std::string& meshFilename, int targetNumPoints,
                                                    double sizeFactor, double anisotropy) {
    GEO::Mesh inputMesh;
    ...
    for (GEO::index_t fi = 0; fi < remeshedMesh.facets.nb(); ++fi) {
        ...
        Vec3i tri(remeshedMesh.facets.vertex(fi, 0), remeshedMesh.facets.vertex(fi, 1),
...
pgo::Mesh::TriMeshGeo pgo::GeogramInterface::remesh(const Mesh::TriMeshGeo& inMesh, int targetNumPoints,
                                                    double sizeFactor, double anisotropy) {
    GEO::Mesh inputMesh;
    GEO::Mesh remeshedMesh;
