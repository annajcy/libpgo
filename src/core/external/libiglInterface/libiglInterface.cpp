...
void pgo::libiglInterface::computeDistanceField(const Mesh::TriMeshGeo& mesh, const EigenSupport::V3d& bmin,
                                                const EigenSupport::V3d& bmax, int res, int robust, int sign,
                                                EigenSupport::VXd& dists, EigenSupport::VXi* triIDsOut,
                                                EigenSupport::MXd* closestPtsOut,
                                                EigenSupport::MXd* closestPtNormalsOut) {
...
void pgo::libiglInterface::computeMarchingCubes(const EigenSupport::V3d& bmin, const EigenSupport::V3d& bmax, int res,
                                                const EigenSupport::VXd& dists, Mesh::TriMeshGeo& outMesh) {
    EigenSupport::MX3d gridPoints(res * res * res, 3);
    EigenSupport::V3d  diff  = bmax - bmin;
    EigenSupport::V3d  delta = diff / (res - 1);
    for (int z = 0; z < res; z++) {
...
namespace pgo::libiglInterface {}  // namespace pgo::libiglInterface
...
void pgo::libiglInterface::computeParameterization(const Mesh::TriMeshGeo& meshIn, Mesh::TriMeshGeo& meshOut,
                                                   int mode) {
    EigenSupport::MXd V;
    EigenSupport::MXi F;
    Mesh::triMeshGeoToMatrices(meshIn, V, F);
...
void pgo::libiglInterface::computeMassMatrix(const Mesh::TriMeshGeo& meshIn, EigenSupport::SpMatD& M, int lumped,
                                             int expand3) {
    EigenSupport::MXd V;
    EigenSupport::MXi F;
    Mesh::triMeshGeoToMatrices(meshIn, V, F);
