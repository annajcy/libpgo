...
void computeDistanceField(const Mesh::TriMeshGeo& mesh, const EigenSupport::V3d& bmin, const EigenSupport::V3d& bmax,
                          int res, int robust, int sign, EigenSupport::VXd& dists,
                          EigenSupport::VXi* triIDsOut = nullptr, EigenSupport::MXd* closestPtsOut = nullptr,
                          EigenSupport::MXd* closestPtNormalsOut = nullptr);

void computeMarchingCubes(const EigenSupport::V3d& bmin, const EigenSupport::V3d& bmax, int res,
