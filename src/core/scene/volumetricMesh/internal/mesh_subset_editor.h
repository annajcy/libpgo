...
public:
    ...
    static void subset_in_place(MeshT& mesh, const std::set<int>& subset_elements, bool remove_isolated_vertices,
    ...
    template <class MeshT>
    static void remove_isolated_vertices(MeshT& mesh, std::map<int, int>* old_to_new_vertex_id_map) {
        VolumetricMeshData& geometry             = MeshMutation::geometry(mesh);
