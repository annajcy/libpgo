...
inline VolumetricMesh::MooneyRivlinMaterial::MooneyRivlinMaterial(std::string name, double density, double mu01,
                                                                  double mu10, double v1)
...
inline VolumetricMesh::MooneyRivlinMaterial::MooneyRivlinMaterial(const MooneyRivlinMaterial& mooneyRivlinMaterial)
    : VolumetricMesh::Material(mooneyRivlinMaterial.getName(), mooneyRivlinMaterial.getDensity()),
      mu01_(mooneyRivlinMaterial.getmu01()),
      mu10_(mooneyRivlinMaterial.getmu10()),
      v1_(mooneyRivlinMaterial.getv1()) {}
