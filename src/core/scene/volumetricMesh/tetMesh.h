...
public:
    ...
    virtual void interpolateGradient(int element, const double* U, int numFields, Vec3d pos, double* grad)
        const override;  // conforms to the virtual function in the base class, "pos" does not affect the computation
