...
// if the input mesh is manifold, self-intersection-free and without boundaries, use pseudo normal for inside/outside
// tests otherwise, use winding numbers to do that
