...
namespace pgo::Mesh {
bool boundingBoxLineSegmentIntersection(const Vec3d& bmin, const Vec3d& bmax, const Vec3d& segmentStart,
                                        const Vec3d& segmentEnd, Vec3d* intersection) {
    /*
...
bool BoundingBox::lineSegmentIntersection(const Vec3d& segmentStart, const Vec3d& segmentEnd,
                                          Vec3d* intersection) const {
...
bool LightBoundingBox::lineSegmentIntersection(const Vec3d& segmentStart, const Vec3d& segmentEnd,
                                               Vec3d* intersection) const {
    return boundingBoxLineSegmentIntersection(bmin_, bmax_, segmentStart, segmentEnd, intersection);
}
