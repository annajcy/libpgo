...
bool getNonManifoldOEdgeTrisMap(BasicAlgorithms::ArrayRef<Vec3i>                triangles,
                                std::unordered_map<OEdgeKey, std::vector<int>>& oedgeTris);
...
// interface inspired from libigl, which is subject to the terms of the Mozilla Public License, v. 2.0. You can obtain
// one copy at https://mozilla.org/MPL/2.0/.
