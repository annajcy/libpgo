...
class SimpleSphere {
public:
    SimpleSphere(const Vec3d& center, double radius) : center_(center), radius_(radius) {}

    SimpleSphere(double x, double y, double z, double radius) : center_(x, y, z), radius_(radius) {}
