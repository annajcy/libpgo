...
struct UTriKey {
    ...
    inline UEdgeKey getSharedUEdge(
        const UTriKey& nbr) const;  // return the first shared UEdge; return (-1,-1) if no shared UEdge
...
// v[0],v[1] and v[2] will be reordered to ensure v[0] <= v[1] and v[0] <= v[2] and (v[0], v[1], v[2]) remain the same
...
struct OTriKey {
    ...
    inline OEdgeKey getSharedOppositeOEdge(
        const OTriKey& nbr) const;  // return first owned OEdge whose reverse is owned by nbr; return (-1,-1) otherwise
    inline UEdgeKey getSharedUEdge(
        const OTriKey& nbr) const;  // return the first shared UEdge; return (-1,-1) if no shared UEdge
...
inline bool UTriKey::shareUEdge(const UTriKey& nbr) const {
    ...
    // else if (v[0] == n[1])
    // {
    //   // if enthering this branch (v[0] == n[1]), then n[0] <= v[1]. we can prove v[1] != n[0], otherwise
    //   v[0]==v[1]==n[0]==n[1], should enter the first branch already
...
inline bool OTriKey::shareUEdge(const OTriKey& nbr) const {
    ...
    // else if (v[0] == n[1])
    // {
    //   // if enthering this branch (v[0] == n[1]), then v[1] != n[0], otherwise v[0]==v[1]==n[0]==n[1], should enter
    //   the first branch already
    //   // same case for v[2] != n[0]
    //   if (v[1] == n[2] || v[2] == n[2])
    //     return true;
    //   return false;
    ...
    // else if (v[0] == n[2])
    // {
    //   // if enthering this branch (v[0] == n[2]), then v[1] != n[0], otherwise v[0]==v[1]==n[0]==n[1], should enter
    //   the first branch already
    //   // same case for v[2] != n[0]
    //   if (v[1] == n[1] || v[2] == n[1])
    //     return true;
...
inline bool OTriKey::shareOEdge(const OTriKey& nbr) const {
    ...
    // {
    //   // if enthering this branch (v[0] == n[1]), then v[2] != n[0], otherwise v[0]==v[2]==n[0]==n[1], should enter
    //   the first branch already if (v[1] == n[2])
    //     return true;
    // }
    // else if (v[0] == n[2]) // case 4, 8
    // {
    //   // if enthering this branch (v[0] == n[2]), then v[1] != n[0], otherwise v[0]==v[1]==n[0]==n[1], should enter
    //   the first branch already if (v[2] == n[1])
    //     return true;
    // }
    // // check case 1, 2, 3
    // if (v[1] == n[1] && v[2] == n[2])
