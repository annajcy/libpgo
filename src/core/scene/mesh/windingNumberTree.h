...
protected:
    ...
    struct Node {
        ...
        const TriMeshRef meshInNode(const TriMeshRef fullMesh) const {
            return TriMeshRef(fullMesh.numVertices(), fullMesh.positions(), triangles);
        }
        const TriMeshRef boundaryInNode(const TriMeshRef fullMesh) const {
            return TriMeshRef(fullMesh.numVertices(), fullMesh.positions(), bouFaces);
        }
    };
