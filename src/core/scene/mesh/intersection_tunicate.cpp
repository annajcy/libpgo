...
//==============================================================================
int simplex_intersection1d(int k, const double* x0, const double* x1, const double* x2, double* alpha0, double* alpha1,
                           double* alpha2) {
    assert(1 <= k && k <= 2);
...
static int simplex_intersection2d(int k, const double* x0, const double* x1, const double* x2, double* alpha0,
    ...
    if (!simplex_intersection1d(1, x0 + 1, x1 + 1, x2 + 1, &ax0, &ax1, &ax2))
        return 0;
    double ay0, ay1, ay2;
    if (!simplex_intersection1d(1, x0, x1, x2, &ay0, &ay1, &ay2))
        return 0;
    // decide which solution is more accurate for barycentric coordinates
    double checkx =
        std::fabs(-ax0 * x0[0] + ax1 * x1[0] + ax2 * x2[0]) + std::fabs(-ax0 * x0[1] + ax1 * x1[1] + ax2 * x2[1]);
    double checky =
        std::fabs(-ay0 * x0[0] + ay1 * x1[0] + ay2 * x2[0]) + std::fabs(-ay0 * x0[1] + ay1 * x1[1] + ay2 * x2[1]);
    if (checkx <= checky) {
        *alpha0 = ax0;
        *alpha1 = ax1;
        *alpha2 = ax2;
...
int simplex_intersection2d(int k, const double* x0, const double* x1, const double* x2, const double* x3,
    ...
    switch (k) {
        ...
        case 3:  // triangle vs. point
            return simplex_intersection2d(1, x3, x2, x1, x0, alpha3, alpha2, alpha1, alpha0);
        default:
...
int simplex_intersection3d(int k, const double* x0, const double* x1, const double* x2, const double* x3,
                           double* alpha0, double* alpha1, double* alpha2, double*) {
    assert(k <= 2);
    // try projecting each coordinate out in turn
    ...
    double p0[2] = {x0[0], x0[2]}, p1[2] = {x1[0], x1[2]}, p2[2] = {x2[0], x2[2]}, p3[2] = {x3[0], x3[2]};
    ...
    switch (k) {
        case 1:  // point vs. tetrahedron
            ...
            *alpha0 = 1;
            ...
            {
                if (simplex_intersection3d(1, x0, x2, x3, x4, alpha0, alpha2, alpha3, alpha4)) {
                    *alpha1 = 0;
                    return 1;
                }
                if (simplex_intersection3d(1, x0, x1, x3, x4, alpha0, alpha1, alpha3, alpha4)) {
                    *alpha2 = 0;
                    return 1;
                }
                if (simplex_intersection3d(1, x0, x1, x2, x4, alpha0, alpha1, alpha2, alpha4)) {
                    *alpha3 = 0;
                    return 1;
                }
                if (simplex_intersection3d(1, x0, x1, x2, x3, alpha0, alpha1, alpha2, alpha3)) {
                    *alpha4 = 0;
                    return 1;
                }
                return 0;
        ...
        case 2:  // segment (x0, x1) vs. triangle (x2, x3, x4)
            ...
            *alpha4 = orient3d(x0, x1, x2, x3);
            ...
            {
                if (simplex_intersection3d(1, x1, x2, x3, x4, alpha1, alpha2, alpha3, alpha4)) {
                    *alpha0 = 0;
                    return 1;
                }
                if (simplex_intersection3d(1, x0, x2, x3, x4, alpha0, alpha2, alpha3, alpha4)) {
                ...
                if (simplex_intersection3d(2, x0, x1, x3, x4, alpha0, alpha1, alpha3, alpha4)) {
                    *alpha2 = 0;
                    return 1;
                }
                if (simplex_intersection3d(2, x0, x1, x2, x4, alpha0, alpha1, alpha2, alpha4)) {
                    *alpha3 = 0;
                    return 1;
                }
                if (simplex_intersection3d(2, x0, x1, x2, x3, alpha0, alpha1, alpha2, alpha3)) {
                    *alpha4 = 0;
                    return 1;
                }
                return 0;
        ...
        case 4:  // tetrahedron vs. point
            return simplex_intersection3d(5 - k, x4, x3, x2, x1, x0, alpha4, alpha3, alpha2, alpha1, alpha0);
        default:
            return -1;  // should never get here
    }
}
