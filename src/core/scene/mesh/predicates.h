...
// double inspherefast(const double pa[3], const double pb[3], const double pc[3], const double pd[3], const double
// pe[3]);
...
bool intersectTriTri(const double pa[3], const double pb[3], const double pc[3], const double qa[3], const double qb[3],
                     const double qc[3]);
...
bool intersectTriAABB(const double tria[3], const double trib[3], const double tric[3], const double bmin[3],
                      const double bmax[3]);
