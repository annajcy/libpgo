...
public:
    ...
    int buildPseudoNormals(TriMeshRef triMesh, const TriMeshNeighbor* triMeshNbr,
                           const Vec3d* triangleNormals = nullptr);
    ...
    void updateVertexPositions(TriMeshRef triMesh, const TriMeshNeighbor* triMeshNbr,
                               const Vec3d* triangleNormals = nullptr);
