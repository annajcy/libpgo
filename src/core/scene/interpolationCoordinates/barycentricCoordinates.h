...
public:
    ...
    BarycentricCoordinates(int numLocations, int numElementVertices, const int* elementVertexIndices,
                           const double* weights, const int* elementIndices = nullptr);

    BarycentricCoordinates(const std::vector<EigenSupport::V4i>& tetVtxIndices,
                           const std::vector<EigenSupport::V4d>& tetWeights, const int* elementIndices = nullptr);
