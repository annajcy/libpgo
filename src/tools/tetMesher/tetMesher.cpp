...
int main(int argc, char* argv[]) {
    ...
    tetgen_cmd.add_description("Use tetgen to tetrahedralize surface");
    tetgen_cmd.add_argument("-i", "--input-mesh").help("Input surface mesh filename").required().metavar("PATH");
    tetgen_cmd.add_argument("-o", "--output-mesh").help("Output surface mesh filename").required().metavar("PATH");
