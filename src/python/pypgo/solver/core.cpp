...
nb::dict diagnosticsToDict(const NonlinearOptimization::SolveDiagnostics &diagnostics)
{
  ...
  out["optimizer_preparation_seconds"] = diagnostics.optimizerPreparationSeconds;
  out["newton_solver_setup_seconds"] = diagnostics.newtonSolverSetupSeconds;
  out["initial_hessian_seconds"] = diagnostics.initialHessianSeconds;
  out["initial_reduced_system_seconds"] = diagnostics.initialReducedSystemSeconds;
  out["initial_symbolic_analyze_seconds"] = diagnostics.initialSymbolicAnalyzeSeconds;
  out["newton_solve_seconds"] = diagnostics.newtonSolveSeconds;
  out["newton_total_iteration_seconds"] = diagnostics.newtonTotalIterationSeconds;
  out["newton_total_evaluate_current_state_seconds"] = diagnostics.newtonTotalEvaluateCurrentStateSeconds;
  out["newton_total_func_grad_hessian_seconds"] = diagnostics.newtonTotalFuncGradHessianSeconds;
  out["newton_total_prepare_reduced_system_seconds"] = diagnostics.newtonTotalPrepareReducedSystemSeconds;
  out["newton_total_ensure_linear_solver_seconds"] = diagnostics.newtonTotalEnsureLinearSolverSeconds;
  out["newton_total_symbolic_analyze_seconds"] = diagnostics.newtonTotalSymbolicAnalyzeSeconds;
  ...
  out["newton_total_expand_reduced_step_seconds"] = diagnostics.newtonTotalExpandReducedStepSeconds;
  out["newton_total_line_search_seconds"] = diagnostics.newtonTotalLineSearchSeconds;
