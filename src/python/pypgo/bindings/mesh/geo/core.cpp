...
PyTriMeshData filterSmallComponents(const PyTriMeshData &surface, int minTriangles, int keepLargest)
{
  Mesh::TriMeshGeo mesh(surface.core());
  nb::gil_scoped_release release;
  return PyTriMeshData(Mesh::filterSmallTriangleComponentsByEdge(mesh.ref(), minTriangles, keepLargest).toMeshData());
}
